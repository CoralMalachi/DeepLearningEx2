...
BATCH_NORMALIZATION_SIZE = 2048  # denotes the number of samples contained in each generated batch.
...
class Part1Model(object):
    ...
    def forward_test_data(self, ner_or_pos):
        ...
        self.create_predictions_file(path_to_test_file, "test3." + ner_or_pos, pred_list)
        ...
        with open(test_file_name, 'r') as unseen_data, open(output_file_name, 'w') as preds_file:
            ...
            for m_cure_line in m_lines_of_file:
                ...
                if m_cure_line == NEW_LINE:
                    ...
                    m_count += 1#update the count value!
